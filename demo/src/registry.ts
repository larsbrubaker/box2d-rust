...
export const SAMPLES: SampleEntry[] = [
  ...
  ...cat("Continuous", "sample_continuous.cpp", [
    ["Bounce House", "planned"],
    ["Bounce Humans", "planned"],
    ["Chain Drop", "planned"],
    ["Chain Slide", "planned"],
    ["Segment Slide", "planned"],
    ["Skinny Box", "planned"],
    ["Ghost Bumps", "planned"],
    ["Speculative Fallback", "planned"],
    ["Speculative Sliver", "planned"],
    ["Speculative Ghost", "planned"],
    ["Pixel Imperfect", "planned"],
    ["Restitution Threshold", "planned"],
    ["Drop", "planned"],
    ["Pinball", "planned"],
    ["Wedge", "planned"],
  ]),
  ...
  ...cat("Events", "sample_events.cpp", [
    ["Sensor Funnel", "planned"],
    ["Sensor Bookend", "planned"],
    ["Foot Sensor", "planned"],
    ["Contact", "planned"],
    ["Platformer", "planned"],
    ["Body Move", "planned"],
    ["Sensor Types", "planned"],
    ["Joint", "planned"],
    ["Persistent Contact", "planned"],
    ["Sensor Hits", "planned"],
    ["Projectile Event", "planned"],
    ["Circle Impulse", "planned"],
  ]),
  ...
  ...cat("Shapes", "sample_shapes.cpp", [
    ["Chain Shape", "planned"],
    ["Chain Segment", "planned"],
    ["Compound Shapes", "planned"],
    ["Filter", "planned"],
    ["Custom Filter", "planned"],
    ["Restitution", "planned"],
    ["Friction", "planned"],
    ["Rolling Resistance", "planned"],
    ["Conveyor Belt", "planned"],
    ["Tangent Speed", "planned"],
    ["Modify Geometry", "planned"],
    ["Chain Link", "planned"],
    ["Rounded", "planned"],
    ["Ellipse", "planned"],
    ["Offset", "planned"],
    ["Explosion", "planned"],
    ["Recreate Static", "planned"],
    ["Box Restitution", "planned"],
    ["Wind", "planned"],
  ]),
  ...cat("Stacking", "sample_stacking.cpp", [
    ["Single Box", "planned"],
    ["Tilted Stack", "planned"],
    ["Vertical Stack", "planned"],
    ["Circle Stack", "planned"],
